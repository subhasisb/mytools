...
import (
	...
	"github.com/subhas/pbs-job-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "127e487d.example.com",
	...
	if err := (&controller.PBSJobReconciler{
		Client:    mgr.GetClient(),
		Scheme:    mgr.GetScheme(),
		PBSClient: pbs.NewPBSClient(ctrl.Log.WithName("pbs-client")),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "PBSJob")
		os.Exit(1)
	}
